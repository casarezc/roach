...
def xbee_received(packet):
    ...
    try:
        ...
        # SET_PID_GAINS
            ...
            rnum = temp[0]
            gains = temp[1:]
            print "Set motor gains", rnum, "to", gains
            for r in shared.ROBOTS:
                if r.DEST_ADDR_int == src_addr:
                    if rnum == 1:
                        r.motor_gains_set_1 = True
                    elif rnum == 2:
                        r.motor_gains_set_2 = True
                    else:
        ...
        # SET_VEL_PROFILE
            ...
            rnum = temp[0]
            velprof = temp[1:]
            print "Set velocity profile", rnum,"to", velprof

        # SET_PHASE
        elif (type == command.SET_PHASE):
            rnum, phase = unpack(pattern, data)
            print "Set phase", rnum,"to", phase
